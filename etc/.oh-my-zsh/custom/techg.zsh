...
alias ipa='ip -4 --brief a'
alias ipb='ip -4 --brief' 
alias ipe='curl -s http://api.ipify.org'
alias ipl='ip -4 --brief l'
alias ipr='ip -4 --brief r'
alias j='jobs'
alias jk='kill %'
alias lf='less +F'
alias nv='nvim'
...
alias psa='ps auxf'
alias pw='pwgen -s -1'
alias pw16='pwgen -s -1 16'
alias pw24='pwgen -s -1 24'
...
alias dcll='docker compose ls'
alias dcls='docker compose ls --quiet'
